       ...
       public override decimal Reward(string input, string number, decimal rewardMoney = decimal.Zero)
        {
            ...
            if (dic.GetNumberLength(3) != 1 || dic.GetNumberLength(2) != 1) return decimal.Zero;

            string[][] inputNumber = input.GetInputNumber();
            if (MathExtend.Intersect(dic[3], inputNumber[0]) == 1 && MathExtend.Intersect(dic[2], inputNumber[1]) == 1)
            {
        ...
        public override IEnumerable<string> ToLimited(string input)
        {
            ...
            foreach (string n1 in inputNumber[0])
            {
                ...
                {
                    yield return string.Concat(n1.RepeaterPadding(3, ","), ",", t.RepeaterPadding(2, ","));
                }
            }
        }
